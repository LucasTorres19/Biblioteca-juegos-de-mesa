...
const library: LibraryItem[] = [
  ...
  { id: "scrabble", title: "Scrabble", category: "Palabras", format: "Juego base", image: "/juegos/scrabble.webp", accent: "from-emerald-400 to-teal-900" },
...
const gameMeta: Record<string, { gameType: string; players: string }> = {
  ...
  scrabble: { gameType: "Word", players: "2-4" },
...
const gameDescriptions: Record<string, string> = {
  ...
  scrabble: "Clasico de palabras cruzadas en tablero donde cada jugada mezcla vocabulario, posicionamiento y gestion de letras.",
